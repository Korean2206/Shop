...
public class KhuyenMaiDAO extends ShopFrameDAO<KhuyenMai, String> {
    ...
    public void insert(KhuyenMai entity) {
        ...
        try {
            Jdbc.update(sqlInsert, entity.getMaKM(), entity.getTenKM(), entity.getMaLoaiKM(), entity.getNgayBatDau(),
                    entity.getNgayKetThuc(), entity.getPhanTram(), entity.getMaNV());
    ...
    public void update(KhuyenMai entity) {
        // TODO Auto-generated method stub
        try {
            Jdbc.update(sqlUpdate, entity.getTenKM(), entity.getMaLoaiKM(), entity.getNgayBatDau(),
                    entity.getNgayKetThuc(), entity.getPhanTram(), entity.getMaNV(), entity.getMaKM());
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    public Double getPhanTramKhuyenMai(String maSP, Date d) {
        try {
            String sql = "{CALL sp_phanTramGiamGia(?,?)}";
            String columns[] = { "PhanTramKM" };
            ResultSet rs = Jdbc.query(sql, maSP, d);
            if(rs.next()) {
                Double ptkm = rs.getDouble(columns[0]);
